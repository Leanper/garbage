...
class CancelRecoderFragment:BaseFragment() {
    private var alertDialog: AlertDialog? = null

    override fun getLayoutId(): Int {
        return R.layout.fragment_cancelrecoder
    }
    ...
    private fun initView() {
        ...
        var info=orderInfoDao?.getState(2)
        ...
        if (info?.size!! >0){
            ...
            //点击事件
            myAdapter.setOnItemClickListener(object : OrderInfoAdapter.OnItemClickListener {
    ...
    private fun ChangeOrder(id:Int) {
